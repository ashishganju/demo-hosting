...
<body>
    ...
    <nav>
        <div class="logo">
            <a href="index.html">SLFindia<em>INTERIORS</em></a>
        </div>
        <!-- <a href="/SLF_INDIA/home.php">Back</a> -->
        <div class="menu-icon">
    ...
    <div id="video-container">
        ...
        <div class="video-content">
            <div class="inner">
              <h1>Welcome to <em>SLFindia-INTERIORS</em></h1>
              <p>we provide you a unique and emersive designs</p>
              <p>converting your boaring building into modern house</p>
